Feature: Calcul de l'AJ nette (cotisations sociales)
  ...
  Scenario: AJ nette avec CSG réduit
    Given l'écran d'accueil est affiché
    When je configure mon profil
      | Annexe | Heures | Salaire | Date anniversaire | CSG    |
      | 8      | 800    | 18000   | 15/09/2026        | reduit |
    Then l'AJ brute affichée est "64.78"
  ...
  Scenario: AJ nette avec régime Alsace-Moselle
    Given l'écran d'accueil est affiché
    When je configure mon profil
      | Annexe | Heures | Salaire | Date anniversaire | Alsace-Moselle |
      | 8      | 800    | 18000   | 15/09/2026        | oui            |
    Then l'AJ brute affichée est "64.78"
